...
def create():
    ...
    api.add_route('/advances-depositors/category-sub-code/{category_sub_code:int}/due-code/{due_code:int}', AdvancesDepositors())
    ...
    api.add_route('/co-obligations/category-sub-code/{category_sub_code:int}/due-code/{due_code:int}', CoObrigations())
    ...
    api.add_route('/discounted-securities/category-sub-code/{category_sub_code:int}/due-code/{due_code:int}', DiscountedSecurities())
    ...
    api.add_route('/financing/category-sub-code/{category_sub_code:int}/due-code/{due_code:int}', Financing())
    ...
    api.add_route('/leasing-operations/category-sub-code/{category_sub_code:int}/due-code/{due_code:int}', LeasingOperations())
    ...
    api.add_route('/lending/category-sub-code/{category_sub_code:int}/due-code/{due_code:int}', Lending())
    ...
    api.add_route('/limit/category-sub-code/{category_sub_code:int}/due-code/{due_code:int}', Limit())
